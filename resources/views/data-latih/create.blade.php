        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl shadow-slate-200/50 rounded-3xl border border-slate-100/60 p-8 relative">
                ...
                <div class="mb-8 relative z-10">
                    <h2 class="text-2xl font-bold text-primary-600">Tambah Data Latih</h2>
                    <p class="text-slate-500 mt-1 text-sm">Tambahkan data mahasiswa historis untuk melatih model C4.5.</p>
                </div>
                
                <form method="POST" action="{{ route('data-latih.store') }}" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    @csrf
