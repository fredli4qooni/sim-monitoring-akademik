    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-saas rounded-3xl border border-slate-100/50 p-8">
                ...
                <form method="POST" action="{{ route('data-latih.update', $mahasiswa->id) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <x-text-input id="angkatan" class="block mt-1 w-full" type="number" name="angkatan" :value="old('angkatan', $mahasiswa->angkatan)" min="2000" max="{{ date('Y') }}" required />
